...
test('合并空行',function(){
    var editor = te.obj[0];
    editor.setContent('<p>欢迎使用</p><p><br /></p><p><br /></p><p>neditor!</p>');
    setTimeout(function(){
        ...
        equal(html,'<p>欢迎使用</p><p><br></p><p>neditor!</p>','合并空行');
        start();
    }, 50 );
    stop();
});
...
test('首行缩进',function(){
    ...
    setTimeout(function(){
        ...
        editor.execCommand('autotypeset');
        ua.manualDeleteFillData(editor.body);
        var html = '<p style=\"text-indent: 2em; text-align: left; \">欢迎使用neditor!</p>';
...
test('trace 2651：字体样式',function(){
    ...
    setTimeout(function(){
        ...
        delete editor.options.autotypeset.textAlign;
        editor.execCommand('autotypeset');
        equal(ua.getChildHTML(editor.body),'<p>欢迎使用neditor!</p>','恢复字体默认样式');
        start();
    }, 50 );
    stop();
});
...
test('去掉class,去掉多余节点',function(){
    var editor = te.obj[0];
    editor.setContent('<p class="noBorder">欢迎使用neditor!</p>');
    editor.options.autotypeset.removeClass = true;
    delete editor.options.autotypeset.textAlign;
    editor.execCommand('autotypeset');
    equal(ua.getChildHTML(editor.body),'<p>欢迎使用neditor!</p>','去掉class');
});
