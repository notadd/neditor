...
test( 'trace 3385：拖拽图像不会把p切开', function () {
    ...
    body.innerHTML = '<p>hel</p><img src="//imgbaidu.b0.upaiyun.com/hi/jx2/j_0001.gif" width="50" height="51" _src="//imgbaidu.b0.upaiyun.com/hi/jx2/j_0001.gif" style="float: right;"><p>lo<br></p>';
    ...
    setTimeout(function(){
        ...
        body.innerHTML = '<p>asds</p><img src="//imgbaidu.b0.upaiyun.com/hi/jx2/j_0001.gif" _src="//imgbaidu.b0.upaiyun.com/hi/jx2/j_0001.gif" width="18" height="20" border="0" hspace="0" vspace="0" title="" style="line-height: 16px; width: 18px; height: 20px; float: right;"><span style="line-height: 16px;"></span><p>ad<br></p>';
        range.selectNode(body.childNodes[1]).select();
        ua.dragend(body);
        setTimeout(function(){
